...
export default function EmergencyPage() {
  return (
    <div className="min-h-screen">
      {/* Emergency Banner */}
      <div className="bg-destructive text-destructive-foreground py-3 px-4 text-center font-medium">
        🚨 EMERGENCY SERVICE HOTLINE: (574) 555-0123 • AVAILABLE 24/7 🚨
      </div>
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Button variant="destructive" size="sm" asChild>
              <Link href="tel:5745550123">Call Emergency</Link>
            </Button>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-destructive to-destructive/80 text-destructive-foreground py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-balance">
              Emergency Mechanical Repairs — Call Now
            </h1>

            <p className="text-xl mb-8 text-destructive-foreground/90 max-w-3xl mx-auto text-balance">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button size="lg" className="bg-white text-destructive hover:bg-white/90 px-8 py-6 text-xl font-bold">
                  ...
                  <Card key={index}>
                    <CardContent className="p-4">
                      <div className="flex items-start gap-4">
                        <div className="w-8 h-8 bg-destructive text-destructive-foreground rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                          {process.step}
                        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="bg-destructive text-destructive-foreground rounded-2xl p-8 lg:p-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Button size="lg" className="bg-white text-destructive hover:bg-white/90 px-12 py-6 text-xl font-bold">
                <Phone className="w-6 h-6 mr-3" />
                CALL (574) 555-0123
              </Button>
            </div>
